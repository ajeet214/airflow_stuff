...
start_date = datetime(2020, 3, 16, 0, 0)
...
airflow_config = {
    "aws_conn_id": "s3-development",
    "DAG_NAME": "MEGA-scalar-historical",
    "default_args": {
...
def megaenergy_split_markets(**context):
    ...
    if raw_table_suffix == 'scalar_usage_eci':
        df = get_data.eci.eci_scalar_historical_to_dataframe(start_date, creds)
        print('@@@@@@@@', df.info())
...
create_raw_tables_scalar = PythonOperator(
    ...
    templates_dict={
        ...
        "process_ts": '2018-01-01T12:00:00',
        "slack-key": slack_key},
    dag=dag,
